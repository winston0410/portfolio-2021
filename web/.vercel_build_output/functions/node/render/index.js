...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-f307f799.js",
      css: [assets + "/_app/assets/start-a8cd1609.css"],
      js: [assets + "/_app/start-f307f799.js", assets + "/_app/chunks/vendor-f13d5b51.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/opensource\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/opensource/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "endpoint",
    ...
    },
    {
      ...
      pattern: /^\/cv\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/cv/index.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/opensource/index.svelte": () => Promise.resolve().then(function() {
    return index$1;
  }),
  "src/routes/cv/index.svelte": () => Promise.resolve().then(function() {
    return index;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-1240266c.js", "css": [], "js": ["pages/__layout.svelte-1240266c.js", "chunks/vendor-f13d5b51.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-e9ee5a96.js", "css": [], "js": ["error.svelte-e9ee5a96.js", "chunks/vendor-f13d5b51.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-93c98731.js", "css": [], "js": ["pages/index.svelte-93c98731.js", "chunks/vendor-f13d5b51.js"], "styles": [] }, "src/routes/opensource/index.svelte": { "entry": "pages/opensource/index.svelte-ce27215d.js", "css": [], "js": ["pages/opensource/index.svelte-ce27215d.js", "chunks/vendor-f13d5b51.js"], "styles": [] }, "src/routes/cv/index.svelte": { "entry": "pages/cv/index.svelte-75fa93a1.js", "css": [], "js": ["pages/cv/index.svelte-75fa93a1.js", "chunks/vendor-f13d5b51.js"], "styles": [] } };
...
var allPromiseSettled = (t) => {
  const result = {};
  let index2 = 0;
  return new Promise((resolve2) => {
    for (const key in t) {
      Promise.resolve(t[key]).then((res) => {
        ...
        if (index2 === Object.keys(t).length) {
          resolve2(result);
        }
      });
    }
...
var getProps = (props) => async ({ fetch: fetch2 }) => {
  const wrapped = {};
  for (const key in props) {
    wrapped[key] = fetch2(props[key]).then((res) => res.json());
  }
  const unwrapped = await allPromiseSettled(wrapped);
  return { props: unwrapped };
};
var load = getProps({ projects: "/api/github" });
var Opensource = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { projects } = $$props;
  console.log("check final value", projects);
  if ($$props.projects === void 0 && $$bindings.projects && projects !== void 0)
    $$bindings.projects(projects);
  return `${$$result.head += `${$$result.title = `<title>Opensource</title>`, ""}`, ""}

<main><h1>Opensource</h1></main>`;
});
